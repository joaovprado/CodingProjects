...
probabilidade = lambda jogadas, vitorias, chance_vitoria: comb(jogadas, vitorias) * chance_vitoria**vitorias * (1-chance_vitoria)** (jogadas-vitorias)

# chance de ter x vitorias em k rodadas = probabilidade(rodadas, vitorias, prob_vitoria)
