...
```{r}
load("/cloud/project/MBA/Introdução ao R e Gráficos/(2) perfil_investidor.RData")
```
...
```{r}
load("/cloud/project/MBA/Introdução ao R e Gráficos/(2) atlas_ambiental.RData")
```
...
preco_acao <- read_excel("/cloud/project/MBA/Introdução ao R e Gráficos/(2) precos_acao.xlsx")
```
...
tempo_dist <- read_excel("/cloud/project/MBA/Introdução ao R e Gráficos/(2) tempo_dist.xls")
```
